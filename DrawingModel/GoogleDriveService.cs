...
namespace GoogleDriveUploader.GoogleDrive
{
    public class GoogleDriveService
    {
        ...
        private List<Google.Apis.Drive.v2.Data.File> ListFileAndFolderWithQueryString(string queryString)
        {
            ...
            ListFileAndFolderWithQueryString2(queryString, returnList, listRequest);
            return returnList;
        }

        //ListFileAndFolderWithQueryString2
        private void ListFileAndFolderWithQueryString2(string queryString, List<Google.Apis.Drive.v2.Data.File> returnList, FilesResource.ListRequest listRequest)
        {
            do
            {
                try
        ...
        public Google.Apis.Drive.v2.Data.File UploadFile(string uploadFileName, string contentType, Action<IUploadProgress> uploadProgressEventHandler = null, Action<Google.Apis.Drive.v2.Data.File> responseReceivedEventHandler = null)
        {
            ...
            UploadFile2(uploadProgressEventHandler, responseReceivedEventHandler, insertRequest, uploadStream);
            return insertRequest.ResponseBody;
        }

        //UploadFile2
        private void UploadFile2(Action<IUploadProgress> uploadProgressEventHandler, Action<Google.Apis.Drive.v2.Data.File> responseReceivedEventHandler, FilesResource.InsertMediaUpload insertRequest, FileStream uploadStream)
        {
